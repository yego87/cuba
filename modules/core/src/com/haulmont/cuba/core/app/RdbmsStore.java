...
public class RdbmsStore implements DataStore {
    ...
    public List<KeyValueEntity> loadValues(ValueLoadContext context) {
        ...
        try (Transaction tx = createLoadTransaction()) {
            ...
            queryBuilder.init(contextQuery.getQueryString(), contextQuery.getFilter(), contextQuery.getParameters(), contextQuery.getNoConversionParams(),
    ...
    protected Query createQuery(EntityManager em, LoadContext context, boolean singleResult) {
        ...
        queryBuilder.init(
                ...
                contextQuery == null ? null : contextQuery.getFilter(),
